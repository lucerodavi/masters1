...
class ApiView extends React.Component {
  ...
  render() {
    const proxies = Controller !== ApiView ? transformProxies(this.props.children) : {
              ...
              <div className="af-class-navigation-wrap">
                ...
                <div className="af-class-menu">
                  <nav role="navigation" className="af-class-navigation-items w-nav-menu">
                    ...
                    <a href="api.html" aria-current="page" className="af-class-navigation-item w-nav-link w--current">api</a>
                  </nav>
            ...
            <div className="af-class-section">
              <div className="af-class-intro-header af-class-cc-subpage">
                <div className="af-class-intro-content">
                  <div className="af-class-heading-jumbo">API<br /></div>
                </div>
              </div>
            </div>
            <div className="af-class-section">
